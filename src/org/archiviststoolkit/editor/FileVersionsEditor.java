...
public class FileVersionsEditor extends DomainEditor {
	/**
	 ...
	 */
	public FileVersionsEditor(JFrame parentFrame) {
		super(FileVersions.class, parentFrame, new FileVersionFields());
	}
	 ...
	 * @param parentFrame the parentframe to render this editor to.
	 */
	public FileVersionsEditor(JDialog parentFrame) {
		super(FileVersions.class, parentFrame, new FileVersionFields());
	}
