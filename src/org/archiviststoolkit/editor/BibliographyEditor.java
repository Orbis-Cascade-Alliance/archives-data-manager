...
public class BibliographyEditor extends DomainEditor {
	 ...
	 */
	public BibliographyEditor(DomainEditor parentFrame) {
		super(Bibliography.class, parentFrame, "Bibliography", new BibliographyFields(parentFrame));
		this.setNavigationButtonListeners(this);
	}
