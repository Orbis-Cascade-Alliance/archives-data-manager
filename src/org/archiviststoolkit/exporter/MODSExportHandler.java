...
public class MODSExportHandler implements Runnable {
    ...
    public void export(File exportFile, DigitalObjects digitalObject, 
        ...
        try {
            ...
            mods.convertDBRecordToFile(digitalObject, file, progressPanel, 
                                       exportOptions.suppressInternalOnly(), true);
    ...
    /**
     * Method to do batch export of digital object records to MODS records
     *
        ...
        if (digitalObjects.size() == 1) {
            ...
            for (DigitalObjects digitalObject: digitalObjects) {
                ...
                if(StringHelper.isNotEmpty(digitalObject.getMetsIdentifier())){
					...
					this.file = new File(exportFile,fileName + "-mods.xml");
                }
                else {
                    this.file = new File(exportFile, digitalObject.getIdentifier() + "-mods.xml");
